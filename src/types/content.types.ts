...
export interface About extends BasePageConfig {
  ...
  publications: {
    /** Whether to display the publications section */
    display: boolean;
    ...
    items: Array<{
      ...
      title: string;
      /**
       * Author list as it should be printed.
       * Wrap your own name in <strong> to make it stand out, e.g.
       * authors: <>Jane Doe, <strong>Your Name</strong>, John Roe</>
       */
      authors: React.ReactNode;
      /** Venue, e.g. 'NeurIPS' or 'ACM CHI'. Leave empty for preprints. */
      venue: string;
      /** Year or submission timeframe, e.g. '2026' */
      year: string;
      /** Optional status badge, e.g. 'Under review', 'Oral', 'Spotlight', 'Preprint' */
      status?: string;
      /** Optional one-line summary shown under the author list */
      description?: React.ReactNode;
      /** Resource links, e.g. PDF / arXiv / Code / Project page */
      links?: Array<{
        /** Link label, e.g. 'PDF' */
        label: string;
        /** Destination URL */
        href: string;
        /** Optional icon name from src/resources/icons.ts */
        icon?: string;
      }>;
    }>;
  };
